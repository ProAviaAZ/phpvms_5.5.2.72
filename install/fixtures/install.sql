...
INSERT INTO `phpvms_airports` (`id`, `icao`, `iata`, `name`, `city`, `country`, `region`, `timezone`, `elevation` `lat`, `lng`, `hub`, `fuelprice`, `chartlink`) VALUES
(1, 'KJFK', 'JFK', 'John F Kennedy International', 'New York', 'US', 'US-NY', 'America-New_York', '13', 40.6398, -73.7789, 1, 0, '');
